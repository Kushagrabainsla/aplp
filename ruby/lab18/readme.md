Lab 18 -- Write a chatbot in Ruby
Due Tuesday by 11:59pm Points 1 Submitting a text entry box
The focus of this lab is to introduce us to Ruby.

First make sure that Ruby is installed on your system.  If not, you can go to https://www.ruby-lang.org/en/downloadsLinks to an external site. for installation details.
